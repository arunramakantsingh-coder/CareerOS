...
PROVIDER_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "anthropic": {"label": "Anthropic Claude", "category": "cloud", "model": "claude-sonnet-4-5", "base_url": "https://api.anthropic.com", "capabilities": ["reasoning", "long_context", "structured_output"]},
