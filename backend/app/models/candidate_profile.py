...
class CandidateProfile(Base, TimestampMixin):
    ...
    # Work preferences / career profile
    ...
    # Sections without separate canonical fact tables.
    # Each item has a stable id so evidence links can point to it.
    projects = Column(JSON, nullable=True)
    accomplishments = Column(JSON, nullable=True)
