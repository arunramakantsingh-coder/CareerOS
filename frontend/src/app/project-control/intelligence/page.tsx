...
export default function IntelligenceEngine() {
  ...
  const load = async () => {
    ...
    if (registryResult.status === 'fulfilled') {
      ...
      // Refreshes must never reset the operator's current selection. The previous implementation
      // captured `selected` in the async load closure and could revert OpenRouter to Ollama.
